# -*- coding: utf-8 -*-
"""Maria_Humberto_Giao_Assessmet_3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1LHW_NMrOvUKnUAOn0ACCRWtQPWRmoa_w
...
# Putting all negatives together
...
#remove stopwords for negative tokens
...
#remove stopwords with the extended list of stopwords for negative tokens
...
#remove stopwords for positive tokens
...
#Lemmatizer left the data in the shape of a string, we need to make it a list
neg_words = lemmatized_neg.split()
pos_words = lemmatized_pos.split()
print(neg_words)
print(pos_words)

# check the frequency distribution of both datasets
...
# leaving only truly negative and truly positive
...
# evaluating model - Accurace report
...
print("maria_humberto_giao_assessmet_3.py")

!pyinstaller --onefile maria_humberto_giao_assessmet_3.py
...
# Import the auto_py_to_exe module
...
!convert .py to .exe
!auto_py_to_exe.convert_file("maria_humberto_giao_assessmet_3.py")

print("maria_humberto_giao_assessmet_3.exe")